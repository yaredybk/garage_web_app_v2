 ...
 * @returns
 */
export default function RenderPlateInspection({
    ...
    return (
        ...
        >
            <div className=" relative  bg-opacity-70 bg-blue-800 text-white w-full      font-bold">
                <span className=" font-mono relative p-[1px] float-right bg-black text-white   bg-opacity-70 mb-auto      font-bold">
                    I{plateobj.idinspection}
                </span>
